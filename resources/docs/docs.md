...
The `home-routes` handler in the `gaming4life2017.routes.home` namespace
...
The `home-page` function will in turn call the `gaming4life2017.layout/render` function
...
The routes are aggregated and wrapped with middleware in the `gaming4life2017.handler` namespace:
...
Request middleware functions are located under the `gaming4life2017.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `gaming4life2017.dev-middleware` namespace found in
...
* Let `mount` know to start the database connection by `require`-ing `gaming4life2017.db.core` in some other namespace.
